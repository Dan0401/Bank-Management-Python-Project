        ...
        try:
            ...
            for accounts_dict in Bank.data:
                ...
                if accounts_dict["account_number"] == search_account_number:
                    ...
                    elif withdraw_amt > target_account_details["balance"]:
                        print(f"Insufficient funds! Your current balance is Rs. {target_account_details['balance']}.")
...
while True:
    print("\n==========================================")
    print("Welcome to Dan's Bank Management System")
    print("==========================================")
    ...
    if choice == '1':
        ...
        print("Thank you for using Dan's Bank Management System. Goodbye!")
        break
    else:
